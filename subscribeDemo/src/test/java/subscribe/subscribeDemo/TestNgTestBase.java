package subscribe.subscribeDemo;
...
public class TestNgTestBase {
  ...
  protected static String baseUrl=Constants.URL;
  ...
  String browser = Constants.BROWSER_TYPE;
	...
	public void setUpTest() {
		...
		report.setSystemInfo("QA Engineer", "Mahesh");

		htmlReporter.config().setDocumentTitle("subscribe");
		htmlReporter.config().setReportName("Demo Reports");
